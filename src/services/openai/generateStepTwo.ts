...
export async function generateStepTwo(
  ...
  const prompt = `Tu es un expert en storytelling. Tu sais parfaitement identifier les points forts d'une personne et les éléments qui rendent légitime et crédible une personne par rapport à une offre.
...
Je vais te donner l'exemple entre /// et ///.  
...
Tu ne dois pas utiliser de markdown, pas de gras, pas de souligné, pas de italique, pas de titres.
